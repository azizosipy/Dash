  ...
  const AgenticSystem = ({ data }: { data: any }) => {
    ...
    const [agentLog, setAgentLog] = useState([
      "Initializing Mineral Exploration Agent...",
      "Loading geological reasoning engine...",
      "Context creation: Processing input geological data...",
      "Analyzing deposit type characteristics...",
      "Evaluating evidence for porphyry classification...",
      "Confidence assessment: 85% for porphyry deposit type...",
      "Analyzing mineralization potential...",
      "Identifying mineral assemblages and commodities...",
      "Grade and tonnage estimation in progress...",
      "Generating exploration recommendations...",
      "Optimizing drilling strategy and survey methods...",
      "Budget allocation optimization...",
      "Prioritizing exploration actions...",
      "Agentic decision process complete."
    ]);
    ...
    return (
      <div className="bg-white p-6 rounded-lg shadow-md">
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-xl font-bold">Agentic AI System</h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            ...
            <div className="h-64 bg-black rounded-lg overflow-auto p-4 font-mono text-xs text-green-400">
          ...
          <div>
            <div className="mb-4">
              <h3 className="text-lg font-semibold mb-2">Agentic System Architecture</h3>
              <div className="p-4 bg-gray-50 rounded-lg">
                <div className="h-48 relative">
                  <svg width="100%" height="100%" viewBox="0 0 400 200">
                    {/* Agentic System Diagram */}
                    <rect x="150" y="10" width="100" height="40" rx="5" fill="#F3E8FF" stroke="#9333EA" strokeWidth="2"/>
                    <text x="200" y="35" textAnchor="middle" fill="#9333EA" fontSize="12" fontWeight="bold">Mineral Exploration Agent</text>
                    
                    <rect x="40" y="80" width="100" height="40" rx="5" fill="#EFF6FF" stroke="#3B82F6" strokeWidth="2"/>
                    <text x="90" y="105" textAnchor="middle" fill="#3B82F6" fontSize="12" fontWeight="bold">Knowledge Base</text>
                    
                    <rect x="150" y="80" width="100" height="40" rx="5" fill="#ECFDF5" stroke="#10B981" strokeWidth="2"/>
                    <text x="200" y="105" textAnchor="middle" fill="#10B981" fontSize="12" fontWeight="bold">Reasoning Engine</text>
                    
                    <rect x="260" y="80" width="100" height="40" rx="5" fill="#FEF2F2" stroke="#EF4444" strokeWidth="2"/>
                    <text x="310" y="105" textAnchor="middle" fill="#EF4444" fontSize="12" fontWeight="bold">ML Models</text>
                    
                    <rect x="40" y="150" width="100" height="40" rx="5" fill="#FFF7ED" stroke="#F97316" strokeWidth="2"/>
                    <text x="90" y="175" textAnchor="middle" fill="#F97316" fontSize="12" fontWeight="bold">Deposit Analyzer</text>
                    
                    <rect x="150" y="150" width="100" height="40" rx="5" fill="#EFF6FF" stroke="#6366F1" strokeWidth="2"/>
                    <text x="200" y="175" textAnchor="middle" fill="#6366F1" fontSize="12" fontWeight="bold">Mineralization Analyzer</text>
                    
                    <rect x="260" y="150" width="100" height="40" rx="5" fill="#FDF4FF" stroke="#D946EF" strokeWidth="2"/>
                    <text x="310" y="175" textAnchor="middle" fill="#D946EF" fontSize="12" fontWeight="bold">Exploration Advisor</text>
                    
                    {/* Connections */}
                    <line x1="200" y1="50" x2="200" y2="80" stroke="#9333EA" strokeWidth="2"/>
                    <line x1="200" y1="50" x2="90" y2="65" stroke="#9333EA" strokeWidth="2"/>
                    <line x1="90" y1="65" x2="90" y2="80" stroke="#9333EA" strokeWidth="2"/>
                    <line x1="200" y1="50" x2="310" y2="65" stroke="#9333EA" strokeWidth="2"/>
                    <line x1="310" y1="65" x2="310" y2="80" stroke="#9333EA" strokeWidth="2"/>
                    
                    <line x1="90" y1="120" x2="90" y2="150" stroke="#3B82F6" strokeWidth="2"/>
                    <line x1="200" y1="120" x2="200" y2="150" stroke="#10B981" strokeWidth="2"/>
                    <line x1="310" y1="120" x2="310" y2="150" stroke="#EF4444" strokeWidth="2"/>
                  </svg>
                </div>
              </div>
            </div>
    ...
    return (
      <div className="bg-white p-6 rounded-lg shadow-md">
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-xl font-bold">Knowledge Base & RAG System</h2>
        </div>
        ...
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            <h3 className="text-lg font-semibold mb-3">RAG System Architecture</h3>
            <div className="p-4 bg-gray-50 rounded-lg h-40 relative overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <svg width="300" height="120" viewBox="0 0 300 120">
                  <rect x="10" y="10" width="80" height="40" rx="5" fill="#EFF6FF" stroke="#3B82F6" strokeWidth="2"/>
                  <text x="50" y="35" textAnchor="middle" fill="#3B82F6" fontSize="12" fontWeight="bold">Knowledge Base</text>
                  
                  <rect x="110" y="10" width="80" height="40" rx="5" fill="#F0FDF4" stroke="#10B981" strokeWidth="2"/>
                  <text x="150" y="35" textAnchor="middle" fill="#10B981" fontSize="12" fontWeight="bold">Vector Embeddings</text>
                  
                  <rect x="210" y="10" width="80" height="40" rx="5" fill="#FEF2F2" stroke="#EF4444" strokeWidth="2"/>
                  <text x="250" y="35" textAnchor="middle" fill="#EF4444" fontSize="12" fontWeight="bold">Prediction Model</text>
                  
                  <rect x="110" y="70" width="80" height="40" rx="5" fill="#EFF6FF" stroke="#6366F1" strokeWidth="2"/>
                  <text x="150" y="95" textAnchor="middle" fill="#6366F1" fontSize="12" fontWeight="bold">RAG System</text>
                  
                  <line x1="50" y1="50" x2="50" y2="60" stroke="#3B82F6" strokeWidth="2"/>
                  <line x1="50" y1="60" x2="120" y2="60" stroke="#3B82F6" strokeWidth="2"/>
                  <line x1="120" y1="60" x2="120" y2="70" stroke="#3B82F6" strokeWidth="2"/>
                  
                  <line x1="150" y1="50" x2="150" y2="70" stroke="#10B981" strokeWidth="2"/>
                  
                  <line x1="250" y1="50" x2="250" y2="60" stroke="#EF4444" strokeWidth="2"/>
                  <line x1="250" y1="60" x2="180" y2="60" stroke="#EF4444" strokeWidth="2"/>
                  <line x1="180" y1="60" x2="180" y2="70" stroke="#EF4444" strokeWidth="2"/>
                </svg>
              </div>
            </div>
          </div>
